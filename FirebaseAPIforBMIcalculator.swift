//
//  FirebaseAPIforBMIcalculator.swift
//  BMIApp_iosTest
//
//  Created by setas on 2019-12-14.
...
class FirebaseAPIforBMIcalculator {
    
    var databaseReference = Database.database().reference(withPath: "BMIApp")
    init(){
    }
